...
public class InstrumentingTranslator extends ReferencingTranslator {
    ...
    private JCTree.JCExpression numKindExp(Type type) {
        String kindVal = "epaj.rt.PrecisionRuntime.NumberKind.";
    ...
    public void visitBinary(JCTree.JCBinary tree) {
        ...
        case CONDITIONAL_OR:
            ...
            JCTree.JCExpression meth =
                dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.countLogicalOp");
        ...
        String opVal = "epaj.rt.PrecisionRuntime.ArithOperator.";
        opVal += tree.getKind();
        ...
        JCTree.JCExpression meth =
            dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.binaryOp");
        JCTree.JCMethodInvocation call = maker.Apply(null, meth,
            List.of(
    ...
    private JCTree.JCExpression storeCall(JCTree typedTree,
        ...
        JCTree.JCExpression meth =
            dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.storeValue");
    ...
    private JCTree.JCExpression memKindExp(MemKind kind) {
        String chain = "epaj.rt.PrecisionRuntime.MemKind." + kind.toString();
    ...
    public void visitIdent(JCTree.JCIdent node) {
        ...
        if (!lvalues.contains(node) && valSymbolKind(node.sym) != null) {
        	if (this.sneakyFieldAccess(node)) {
        		...
        		JCTree.JCExpression meth =
                    dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.loadField");
            ...
            JCTree.JCExpression meth =
                dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.loadLocal");
            JCTree.JCExpression expr = maker.Apply(
            	List.of(boxedTypeExp(node.type)),
            	meth,
                List.of(
    ...
    public void visitSelect(JCTree.JCFieldAccess node) {
        ...
        if (node.toString().startsWith("epaj.rt."))
            return;
    ...
    public void visitIndexed(JCTree.JCArrayAccess node) {
        ...
        if (!lvalues.contains(node)) {
            JCTree.JCExpression meth =
                dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.loadArray");
            JCTree.JCExpression expr = maker.Apply(
            	List.of(boxedTypeExp(node.type)),
            	meth,
                List.of(
    ...
    public void visitAssign(JCTree.JCAssign node) {
        ...
        if (oldLhs instanceof JCTree.JCFieldAccess ||
            ...
            JCTree.JCExpression meth =
                dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.storeField");
            JCTree.JCExpression expr = maker.Apply(
            ...
            // Call into runtime to execute store.
            JCTree.JCExpression meth =
                dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.storeLocal");
            JCTree.JCExpression expr = maker.Apply(
            	List.of(boxedTypeExp(oldLhs.type)),
            	meth,
                List.of(
        	...
        	// Call into runtime to execute store.
            JCTree.JCExpression meth =
                dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.storeArray");
            JCTree.JCExpression expr = maker.Apply(
            	List.of(boxedTypeExp(oldLhs.type)),
            	meth,
                List.of(
    ...
    private JCTree.JCExpression assignopCall(
        ...
        // Operation kind.
        String opExp = "epaj.rt.PrecisionRuntime.ArithOperator." + opName;
                ...
                instanceof Symbol.MethodSymbol) 
        {
            ...
            JCTree.JCExpression call = maker.Apply(null,
              dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.assignopLocal"),
              List.of(
                ref,
                dotsExp(opExp),
                rhs,
        ...
        // Array accesses.
            ...
            JCTree.JCExpression call = maker.Apply(
              ...
              dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.assignopArray"),
              List.of(
                access.indexed,
                access.index,
                dotsExp(opExp),
            		...
            		sneakyFieldAccess((JCTree.JCIdent)arg)))
        {
            ...
            JCTree.JCExpression call = maker.Apply(
              List.of(boxedTypeExp(oldArg.type)),
              dotsExp("epaj.rt.PrecisionRuntimeRoot.impl.assignopField"),
              List.of(
                selected,
                maker.Literal(name),
                dotsExp(opExp),
